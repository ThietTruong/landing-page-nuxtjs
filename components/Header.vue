      ...
      <div class="header">
        ...
        <div class="header--list-item">
          <div class="header--item">
            <a class="header--item__link active" href="#">About us</a>
          </div>
          <div class="header--item">
            <a class="header--item__link" href="#">Games</a>
          </div>
          <div class="header--item">
            <a class="header--item__link" href="#">Partner</a>
          </div>
          <div class="header--item">
            <a class="header--item__link" href="#">Contact us</a>
          </div>
          <div class="header--item">
